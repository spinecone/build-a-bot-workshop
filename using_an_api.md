...
Now all you have to do is pass the text you've created from the data to Tweepy in order to tweet it. You can read data from pretty much an API just using requests.get() and json()!
